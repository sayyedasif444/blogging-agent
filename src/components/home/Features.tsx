...
const features = [
  {
    ...
    description: "Generate high-quality blog content in seconds with our advanced AI algorithms."
  },
  {
    icon: (
      <svg className="w-8 h-8" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    title: "Smart Editing",
    description: "Edit and refine your content with intelligent suggestions and real-time feedback."
  },
  {
    icon: (
      <svg className="w-8 h-8" fill="none" stroke="currentColor" viewBox="0 0 24 24">
  ...
  },
  {
    ...
    description: "Ensure your content meets high standards with automated quality checks."
  },
  {
    icon: (
      <svg className="w-8 h-8" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    description: "Publish your content directly to your blog with one-click publishing."
  },
  {
    icon: (
      <svg className="w-8 h-8" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    <section id="features" className="py-20 bg-black">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div ref={ref} className="text-center mb-16">
          ...
          >
            Everything you need to create, edit, and publish engaging blog content with AI assistance.
          </motion.p>
        </div>
