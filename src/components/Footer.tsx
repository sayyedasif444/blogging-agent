        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="col-span-1 md:col-span-2">
            <div className="flex items-center mb-4">
              ...
              />
              <span className="text-xl font-bold">Dev & Debate</span>
            </div>
            <p className="text-gray-400 mb-4 max-w-md">
              AI-powered blog generation tool. Create engaging, high-quality blog posts with advanced AI assistance.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-3">
              <li>
                <Link href="/blog-tool" className="text-gray-400 hover:text-white transition-colors">
                  Create Blog
                </Link>
              </li>
              <li>
